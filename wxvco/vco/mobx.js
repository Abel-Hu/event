(function(f) { if (typeof exports === 'object' && typeof module !== 'undefined') { module.exports = f() } else if (typeof define === 'function' && define.amd) { define([], f) } else { var g; if (typeof window !== 'undefined') { g = window } else if (typeof global !== 'undefined') { g = global } else if (typeof self !== 'undefined') { g = self } else { g = this }g.mobx = f() } })(function() {
    ...
    (function (global) {
      ...
      function startAction(actionName, fn, scope, args) {
        ...
        if (notifySpy) {
          ...
          if (l > 0) {
            for (var i = 0; i < l; i++) { flattendArgs[i] = args[i] }
          }
          spyReportStart({
            type: 'action',
            name: actionName,
      ...
      var ObservableMap = (function () {
        ...
        ObservableMap.prototype.merge = function (other) {
          ...
          runInTransaction(function () {
            if (isPlainObject(other)) { Object.keys(other).forEach(function (key) { return _this.set(key, other[key]) }) } else if (Array.isArray(other)) {
              other.forEach(function (_a) {
                var key = _a[0], value = _a[1]
                return _this.set(key, value)
              })
            } else if (isES6Map(other)) { other.forEach(function (value, key) { return _this.set(key, value) }) } else if (other !== null && other !== undefined) { fail('Cannot initialize map from ' + other) }
          })
          return this
        }
